...
//
//     mainFieldValues?.forEach((QFieldModel field) => entityToAddMap =
//         entityToAddMap.update(
//             field.uid,
//             (value) => mapFieldToValueType(
//                 value: field.value,
//                 values: field.values,
...
//
//     ///
//     final SyncableEntity submission =
...
//     mainFieldValues?.forEach((QFieldModel field) => formData[field.uid] =
//         mapFieldToValueType(
//             value: field.value,
//             values: field.values,
//             valueType: field.valueType?.name));
...
//
//     final SyncableStatus syncableStatus =
//         SyncableStatusUtil.getEnumValue(syncable?.status);
//
