...
class _QDropDownSearchValueAccessor<T, V> extends ControlValueAccessor<T, V> {
  final List<V> items;

  final DropDownSearchValueAccessor<T, V> dropDownValueAccessor;

  _QDropDownSearchValueAccessor({
    this.items = const [],
...
///
class QReactiveDropdownSearch<T, V> extends QReactiveFormField<T, V> {
  ...
  @override
  QReactiveFormFieldState<T, V> createState() =>
      _ReactiveDropdownSearchState<T, V>();
}

class _ReactiveDropdownSearchState<T, V> extends QReactiveFormFieldState<T, V> {
