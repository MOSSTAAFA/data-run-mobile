...
//             children: [
//               Text(
//                 widget.fieldModel.formattedLabel,
...
//                         name: '${widget.fieldModel.name}_first_name',
//                         enabled: widget.fieldModel.disabled,
...
//                   Expanded(
//                     child: FormBuilderTextField(
//                         name: '${widget.fieldModel.name}_middle_name',
//                         enabled: widget.fieldModel.disabled,
...
//                   Expanded(
//                     child: FormBuilderTextField(
//                         name: '${widget.fieldModel.name}_last_name',
//                         enabled: widget.fieldModel.disabled,
