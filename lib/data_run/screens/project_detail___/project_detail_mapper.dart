...
// import 'package:mass_pro/core/di/providers.dart';
// import 'package:mass_pro/core/event/event_extensions.dart';
//
// part 'project_detail_mapper.g.dart';
//
// @riverpod
// ProjectDetailMapper projectDetailMapper(ProjectDetailMapperRef ref) {
//   return ProjectDetailMapper(ref);
// }
//
// class ProjectDetailMapper {
//   // final DhisPeriodUtils periodUtils;
//   // final CrashReportController crashReportController;
//   ProjectDetailMapper(this.ref);
//
//   final ProjectDetailMapperRef ref;
//
