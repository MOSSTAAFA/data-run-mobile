...
class ProjectDetailDeckRepositoryImpl implements ProjectDetailDeckRepository {
  ProjectDetailDeckRepositoryImpl(this.ref) {
  ...
  final ProjectDetailDeckRepositoryRef ref;
  ...
  @override
  Future<IList<ProjectDetailItemModel>> projectDetailDeckItems(
      SyncStatusData syncStatusData) async {
    IList<ProjectDetailItemModel> projectViewModels =
        await projectDetailDeckCachedItems(
