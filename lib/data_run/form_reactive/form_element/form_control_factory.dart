...
import 'package:mass_pro/data_run/form_reactive/form_element/form_element_validator.dart';
...
extension FormTemplateControlFactory<T> on FormElementInstance<T?> {
  ...
  static AbstractControl<dynamic> createControl(
      FieldTemplate fieldTemplate,
      {Map<String, List<FormOption>> formOptionsMap = const {}}) {
  ...
  static AbstractControl<dynamic> createFormControl(FieldTemplate fieldTemplate,
    ...
    switch (fieldTemplate.type) {
      ...
      case ValueType.SelectMulti:
        return FormArray<String>(
          [], //  fieldOptions.map((option) => FormControl<String>()).toList(),
        );
      default:
        throw UnsupportedError('Unsupported element type: ${fieldTemplate}');
    }
  }
}
