...
//   final formVersion = FormTemplateVQuery(database: db);
//   final formMap = {};
//   formMap.addAll(formSampleData);
//   formSampleData['formVersions'] = [formMap];
//   FormTemplate form = FormTemplate.fromJson(formSampleData);
//
//   await formQuery.setData(form);
//
//   final savedForm =
//       await D2Remote.formModule.formTemplate.withFormVersions().getOne();
// }
