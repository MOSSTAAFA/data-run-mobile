...
class FormViewModelOld extends GetxController implements Listenable {
  // static const TAG = 'FormViewModel';

  // GeometryController _geometryController = GeometryController(GeometryParserImpl());
  FormViewModelOld(this._repository /*, this._geometryController*/);
  ...
  void loadData() {
    ...
    _repository
        .fetchFormItems()
        .then((result) => _items.value = result)
        // finally
        .catchError((e) {
      print(e); /*Timber.e(e)*/
      _items.value = [];
