...
class LayoutProviderImpl implements LayoutProvider {
  ...
  int getLayoutByType(
    ...
    switch (valueType) {
      case ValueType.AGE:
        return 0; //R.layout.form_age_custom
      case ValueType.DATE:
      case ValueType.TIME:
      case ValueType.DATETIME:
        return 0; //R.layout.form_date_time
      case ValueType.LONG_TEXT:
        return 0; //R.layout.form_long_text_custom
      case ValueType.ORGANISATION_UNIT:
        return 0; //R.layout.form_org_unit
      case ValueType.COORDINATE:
        return 0; //R.layout.form_coordinate_custom
      case ValueType.IMAGE:
        return 0; //R.layout.form_picture
      case ValueType.TEXT:
        return getLayoutForOptionSet(optionSet, sectionRenderingType,
            renderingType, 0 //R.layout.form_edit_text_custom
            );
      ...
      case ValueType.BOOLEAN:
        switch (renderingType) {
          ...
          case ValueTypeRenderingType.DEFAULT:
            return 0; //R.layout.form_radio_button
          case ValueTypeRenderingType.TOGGLE:
            switch (valueType) {
              case ValueType.TRUE_ONLY:
                return 0; //R.layout.form_toggle
              default:
                return 0; //R.layout.form_radio_button
            }
          case ValueTypeRenderingType.HORIZONTAL_CHECKBOXES:
          case ValueTypeRenderingType.VERTICAL_CHECKBOXES:
            return 0; //R.layout.form_check_button
          default:
            return 0; //R.layout.form_radio_button
        }
      case ValueType.LETTER:
        return 0; //R.layout.form_letter
      case ValueType.PHONE_NUMBER:
        return 0; //R.layout.form_phone_number
      case ValueType.EMAIL:
        return 0; //R.layout.form_email
  ...
  int getLayoutForOptionSet(
    ...
    if (shouldRenderAsMatrixImage(
      ...
      return 0; //R.layout.form_option_set_matrix
    } else if (shouldRenderAsSelector(optionSet, renderingType)) {
      return 0; // R.layout.form_option_set_selector
    } else if (shouldRenderAsSpinner(optionSet)) {
      return 0; // R.layout.form_option_set_spinner
    } else if (shouldRenderAsScan(renderingType)) {
      return 0; // R.layout.form_scan
    } else if (shouldRenderAsSelector(optionSet, renderingType)) {
      return 0; // R.layout.form_option_set_selector
    } else {
