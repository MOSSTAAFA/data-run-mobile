...
// import 'package:datarun/main/usescases/login/sync_is_performed_interactor.dart';
...
//         error.cause != null
//             ? await _handleError(
//                 error.cause! as DException, serverUrl, userName, pass)
...
//   }
//
//   Future<void> _handleError(DException throwable, String serverUrl,
