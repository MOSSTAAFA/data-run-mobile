...
String _$syncScreenPresenterHash() =>
    r'0dcad717fe97f72e7b8481184345d946c4fe5a97';
...
typedef SyncScreenPresenterRef = AutoDisposeProviderRef<SyncPresenter>;
...
/// See also [syncScreenPresenter].
class SyncScreenPresenterFamily extends Family<SyncPresenter> {
  /// See also [syncScreenPresenter].
...
/// See also [syncScreenPresenter].
class SyncScreenPresenterProvider extends AutoDisposeProvider<SyncPresenter> {
  /// See also [syncScreenPresenter].
