...
class __$$ParseExceptionImplCopyWithImpl<$Res>
    extends _$DateTimeFailureCopyWithImpl<$Res, _$ParseExceptionImpl>
...
class _$ParseExceptionImpl implements ParseException {
  const _$ParseExceptionImpl([this.message = 'Exception', this.cause]);
...
abstract class ParseException implements DateTimeFailure, ThrowableException {
  const factory ParseException(
      [final String message,
      final CaughtException? cause]) = _$ParseExceptionImpl;
