...
class PrePopulatedIndexedTree extends StatefulWidget {
  const PrePopulatedIndexedTree({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _PrePopulatedIndexedTreeState createState() => _PrePopulatedIndexedTreeState();
}

class _PrePopulatedIndexedTreeState extends State<PrePopulatedIndexedTree> {
  int stateCount = 0;
