...
class _ExpansionPanelListExampleState extends State<ExpansionPanelListExample> {
  ...
  Widget _buildPanel() {
    return FormBuilderField<List<Map<String, dynamic>>?>(
      ...
      builder: (FormFieldState<List<Map<String, dynamic>>?> section) {
                      ...
                      return Column(
                        children: [
                          TextFormField(
                           ...
                           onChanged: (value) => field.didChange(field.value?..['name'] = value),
                          ),
                          const SizedBox(height: 8,),
                          TextFormField(
                            decoration: InputDecoration(labelText: 'age'),
                            onChanged: (value) => field.didChange(field.value?..['age'] = value),
                          ),
                        ],
                      );
                    },
