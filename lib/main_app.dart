...
Future<void> _navigate(BuildContext context, String route,
    {bool isDialog = false,
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return InkWell(
              onTap: () {
                _navbarNotifier.hideBottomNavBar = false;
                _navigate(context, FeedDetail.route,
          ...
          itemBuilder: (context, index) {
            return Padding(
              ...
              child: InkWell(
                  onTap: () {
                    _navbarNotifier.hideBottomNavBar = false;
                    _navigate(context, ProductDetail.route,
                        isRootNavigator: false,
                        arguments: {'id': index.toString()});
                  },
      ...
      body: Column(
        ...
        children: [
          ...
          TextButton(
              onPressed: () {
                _navbarNotifier.hideBottomNavBar = false;
                _navigate(context, ProductComments.route,
      ...
      appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                _navigate(context, ProfileEdit.route);
              },
            )
          ],
