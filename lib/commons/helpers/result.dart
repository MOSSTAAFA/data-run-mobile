...
/// first.
abstract class Result<S> with EquatableMixin {
...
class _SuccessResult<S> extends Result<S> {
  ...
  @override
  _SuccessResult<T> either<T>(Exception Function(Exception error) fnFailure,
...
class _FailureResult<S> extends Result<S> {
  ...
  @override
  _FailureResult<T> either<T>(Exception Function(Exception error) fnFailure,
      T Function(S data) fnData) {
