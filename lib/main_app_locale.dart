...
//         DataRunAppLocalizations.delegate,
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text(DataRunAppLocalizations.of(context).translate('title')),
//         actions: [
...
//       ),
//       body: Center(
//         child: Text(DataRunAppLocalizations.of(context).translate('message')),
//       ),
//     );
//   }
// }
